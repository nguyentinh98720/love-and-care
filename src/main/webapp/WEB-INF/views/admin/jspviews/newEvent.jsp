...
<!-- LINK HERE gửi thông tin về server -->
                            <form action="https://love-and-care.herokuapp.com/chuong-trinh/ck-them-chuong-trinh" method="post" onsubmit="return creatNewEvent()">
                            <input type="hidden" name="eventId" id="eventId" value="${requestScope.eventId}"/>
...
<!-- LINK HERE dẫn về trang chủ khi không submit triển khai chương trình -->
                                    <button class="btn btn-secondary mx-4" role="button" type="button" onclick="canceCreateEvent()">Hủy bỏ</button>
