...
<!-- LINK HERE gửi thông tin về server -->
                            <form action="/LoveAndCare/chuong-trinh/hoan-thanh-cap-nhat" method="post" onsubmit="return editExistEvent()" enctype="multipart/form-data">
...
<!-- DETAIL -->
                                ...
                                <div class="row my-2" id="imageEventManage">
                                    <p class="col-12 col-lg-12">Hình ảnh chương trình đang sử dụng</p>
                                    <!-- hình ảnh sẽ được chèn vào đây -->
                                </div>
                                <div class="form-group my-2">
                                    <label for="addImgEditEvent">Thêm hình ảnh mới (&lt;10Mb)</label>
<!-- IMAGES -->
                                    <input type="file" class="input-group-text" id="addImgEditEvent" name="images" multiple>
                                </div>
